...
<script type="text/javascript">
	...
	<div class="container-fluid">
	  <div class="row p-3">
			...
			List<BookDtls> list2 = dao2.getAllVintageBook();
				...
				<div class="crd-ho card ">
					...
					<div class="card-body text-center">
						...
						<img alt="Responsive image" src="Book/<%=b.getPhotoName()%>"
							style="width: 100px; height: 150px" class="img-fluid">
						...
						<%}else{%>
						    <a href="vintage_cart?bid=<%=b.getBookId() %>&&uid=<%=u.getUser_id() %>" class="btn btn-outline-dark btn-sm ml-2 mr-2">
							 <i class="fa-solid fa-cart-shopping"></i> Add Cart</a>
						<%}
						 %>
